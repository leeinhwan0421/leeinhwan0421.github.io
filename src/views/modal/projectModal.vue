					...
					<div class="container-fluid px-4 px-lg-5 py-0 mt-5 mb-3">
						...
						<section v-if="pdfUrl" class="mb-5">
							...
							<div class="d-block d-md-none">
								<a :href="pdfUrl" target="_blank" class="btn btn-dark w-100 py-3 fw-bold d-flex align-items-center justify-content-center" download>
									<i class="bi bi-file-earmark-pdf-fill fs-4 me-2"></i>
									{{ $t('projectModal.presentationDownload') }}
								</a>
								<p class="text-muted small text-center mt-2">
									<i class="bi bi-info-circle me-1"></i>{{ $t('projectModal.presentationDescription') }}
								</p>
							</div>
						</section>
